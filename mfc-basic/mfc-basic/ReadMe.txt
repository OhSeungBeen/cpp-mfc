================================================================================
    MFC 라이브러리 : mfc-basic 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 mfc-basic 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 mfc-basic 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
mfc-basic.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CmfcbasicApp 응용 프로그램
    클래스를 선언합니다.

mfc-basic.cpp
    응용 프로그램 클래스 CmfcbasicApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\mfc-basic.ico
    ...
    주 리소스 파일인 mfc-basic.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 mfc-basic.pch와
